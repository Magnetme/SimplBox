 ...
 *
 * Edited by us, to be compatible with angular
 ***/
/* jshint ignore:start */
module.exports = {
    setUpZoom : function () {
            ...
            SimplBox.prototype = {
                ...
                calculateImagePositionAndSize : function (p_Element, p_Resize) {
                    ...
                    temporaryImageObject.onload = function () {
                        ...
                        p_Element.style.border = "10000px solid rgba(255, 255, 255, 0.7)";
                        p_Element.style["box-sizing"] = "content-box";
                        p_Element.style["margin-top"] = "-10000px";
                        p_Element.style["margin-left"] = "-10000px";
                        p_Element.style["z-index"] = "99999";
